  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      starter.setup {
        ...
        items = {
          { name = 'Find file      f', action = 'Telescope find_files', section = 'Files' },
          { name = 'Recent files   r', action = 'Telescope oldfiles', section = 'Files' },
          { name = 'Browse here    -', action = 'Oil', section = 'Files' },
          { name = 'Grep search    g', action = 'Telescope live_grep', section = 'Search' },
          { name = 'Harpoon menu   h', action = function() require('harpoon').ui:toggle_quick_menu(require('harpoon'):list()) end, section = 'Harpoon' },
        ...
        footer = table.concat({
          ...
          '   <Space>h   open harpoon menu',
          '   Ctrl+1/2/3/4  jump to file 1/2/3/4',
          '─────────────────────────────────────────',
          ' -  browse files    <Space>?  full cheatsheet',
          '─────────────────────────────────────────',
        }, '\n'),
        content_hooks = {
